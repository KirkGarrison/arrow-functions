...
// Without the arrows Joe.scope returns the student name and hometown info, with the arrows it returns a message about windows and the 
// document. I don't have a better explanation for what is happening.
// 2. What is "this" when joe.scopeArrow() is invoked?
// Joe.scopeArrow returns undefined.
// 3. Explain why "this" is different when an arrow function is used.
// From what I can find in google, arrow functions does not have it's own this or super, and shouldn't be used as methods.
// It's also not suitable for calling which relies on establishing scope.
